...
b2 = tk.Button(root, text="Start", bg="black", fg="white", command=root.destroy, activeforeground="black", activebackground="red")
b2.place(x=0, y=80, width=120, height=80)

b3 = tk.Button(root, text="Stop", bg="black", fg="white", command=root.destroy, activeforeground="black", activebackground="red")
b3.place(x=0, y=160, width=120, height=80)

b4 = tk.Button(root, text="Altro", bg="black", fg="white", command=root.destroy, activeforeground="black", activebackground="red")
